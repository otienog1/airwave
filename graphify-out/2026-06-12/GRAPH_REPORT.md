# Graph Report - airwave  (2026-06-12)

## Corpus Check
- 152 files · ~106,900 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1221 nodes · 1921 edges · 97 communities (74 shown, 23 thin omitted)
...
Cohesion: 0.22
Nodes (11): Icecast Metadata Proxy Route, useStreamMetadata Hook (Now Playing polling), getTrending Aggregation, Play Event Pipeline (title-change detection), PlayDocument (plays collection), SnapshotDocument (stationSnapshots collection), TTL Auto-Purge Indexes, Smart End-of-Song Poll Scheduler (+3 more)
...
Cohesion: 0.23
Nodes (9): Heartbeat Session System, Flask analytics_bp (MongoDB aggregations), backend/app/db.py (PyMongo connection helpers), Counters Collection (auto-increment integer IDs), Plain Python Model Classes (no ORM), stationPlays Collection (app click events), App Engagement Rate Metric, GET /api/analytics/audience Route (+1 more)
...
Cohesion: 0.16
Nodes (10): $(), b(), deleteCacheAndMetadata(), et, F, G, i, k() (+2 more)
...
Cohesion: 0.07
Nodes (28): inputStyle, LoginModal(), LoginModalProps, Mode, inputStyle, ProfileModal(), ProfileModalProps, Tab (+20 more)

### Community 26 - "Community 26"
Cohesion: 0.14
Nodes (15): AdminPage(), emptyForm(), GENRES, inputStyle, PlayerContext, PlayerContextValue, PlayerProvider(), useAudioPlayer() (+7 more)
...
Cohesion: 0.10
Nodes (29): GET(), FlaskHealthResponse, GET(), POST(), GET(), POST(), POST(), closePlay() (+21 more)
...
Cohesion: 0.04
Nodes (44): AudienceTab Component, Analytics Dashboard Implementation Plan, lib/analyticsApi.ts Typed Fetchers, Chart Components (LineChart, DonutChart, HBarChart, HeatmapGrid), File Map, LiveStatusBar (15s polling), Task 10: Create SongsTab, Task 11: Create GenresTab (+36 more)

### Community 33 - "Community 33"
Cohesion: 0.15
Nodes (11): ModernAirwave(), useFavorites(), useKeyboardShortcuts(), loadIds(), pushRecentStation(), useRecentStations(), useStationFilter(), LibraryContent() (+3 more)

### Community 34 - "Community 34"
Cohesion: 0.24
Nodes (7): fetchWithRefresh(), m(), s, st(), T(), U(), v
...
Cohesion: 0.10
Nodes (24): ScrollState, useScrollDirection(), useSleepTimer(), TabBar(), TABS, cn(), AudioPlayer(), AudioPlayerProps (+16 more)

### Community 38 - "Community 38"
Cohesion: 0.20
Nodes (10): Environment variables checklist, File Map, Security & Auth Hardening — Implementation Plan, Task 1: Backend test infrastructure, Task 2: JWT cookie config & CORS lockdown (`backend/app/__init__.py`), Task 3: Login & Register → cookie responses, Task 4: `/refresh` and `/logout` endpoints, Task 5: Frontend — `fetchWithRefresh` & `lib/api.ts` cleanup (+2 more)

### Community 39 - "Community 39"
Cohesion: 0.83
Nodes (3): GET /api/listeners/counts Aggregation Route, ListenerSessionDocument, useListeners Hook
...
Cohesion: 0.12
Nodes (16): Architecture, `backend/app/auth_bp.py`, `backend/app/__init__.py`, Backend Changes (`backend/`), `context/AuthContext.tsx`, Edge Cases, Environment Variables, Files to Create (+8 more)
...
Cohesion: 0.31
Nodes (11): register_analytics_commands(), ensure_counters(), ensure_indexes(), get_client(), get_counters_col(), get_db(), get_plays_col(), Sync counters to max existing IDs to prevent collisions after manual inserts. (+3 more)
...
Cohesion: 0.11
Nodes (18): Analytics Audience Tab — Design Spec, `app/admin/analytics/page.tsx`, Approach, Audience Tab Content, `backend/app/db.py`, Backend Changes, `components/analytics/tabs/AudienceTab.tsx`, Data Sources (+10 more)
...
Cohesion: 0.60
Nodes (3): fetchWithRefresh Wrapper, HttpOnly Cookie JWT Delivery, Cookie Token Flow with Silent Refresh & Rotation
...
Cohesion: 0.13
Nodes (15): KpiCard(), Props, DAYS, HeatmapGrid(), Props, LineChart(), Props, AudienceResponse (+7 more)
...
Cohesion: 0.13
Nodes (19): AudienceStation, AudienceTimeBucket, DailyStatEntry, DashboardOverview, fetchAudience(), fetchGenres(), fetchRegions(), fetchStationStats() (+11 more)

### Community 58 - "Community 58"
Cohesion: 0.27
Nodes (7): usePlayer(), NowPlayingSheet(), NowPlayingSheetProps, PersistentAudioPlayer(), HistoryEntry, RecentTracks(), RecentTracksProps
...
Cohesion: 0.29
Nodes (7): DashboardResponse, fetchDashboard(), RealTimeResponse, HealthTab(), Props, Props, Props
...
Cohesion: 0.22
Nodes (9): MongoDB Client Singleton (lib/mongodb.ts), Flask Deep Health Check, Next.js Error Boundaries (error.tsx + global-error.tsx), Next.js /api/health Aggregation Route, Monitoring — Implementation Plan, Task 1: Deep health check on Flask backend, Task 2: Next.js `/api/health` aggregation route, Task 3: Next.js `app/error.tsx` route-segment error boundary (+1 more)
...
Cohesion: 0.19
Nodes (9): HBarChart(), Props, fetchTrending(), PERIOD_HOURS, TrendingEntry, fmtDuration(), OverviewTab(), Props (+1 more)

### Community 71 - "Community 71"
Cohesion: 0.25
Nodes (7): DonutChart(), PALETTE, Props, GenreEntry, RegionEntry, GenresTab(), Props
...
## Knowledge Gaps
- **426 isolated node(s):** `extends`, `Tab`, `TABS`, `VALID_PERIODS`, `GENRES` (+421 more)
...
- **Why does `$()` connect `Analytics Dashboard Plans` to `Community 34`, `Community 67`, `Community 69`, `Community 45`, `Community 24`?**
